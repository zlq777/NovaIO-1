...
final class NovaIOClientImpl implements NovaIOClient {
     ...
     */
    @Override
    public AsyncFuture<OperationResult> addDataNodeCluster(String clusterName, InetSocketAddress[] addresses) {
        AsyncFuture<OperationResult> asyncFuture = AsyncFuture.of(OperationResult.class);
        long sessionId = asyncFuture.getSessionId();
     ...
     */
    @Override
    public AsyncFuture<OperationResult> removeDataNodeCluster(String clusterName) {
        AsyncFuture<OperationResult> asyncFuture = AsyncFuture.of(OperationResult.class);
        long sessionId = asyncFuture.getSessionId();
     ...
     */
    @Override
    public AsyncFuture<OperationResult> createNameSpace(String spaceId) {
        AsyncFuture<OperationResult> asyncFuture = AsyncFuture.of(OperationResult.class);
        long sessionId = asyncFuture.getSessionId();

        ByteBufMessage message = ByteBufMessage.build("/create-namespace").doWrite(msg -> {
            msg.writeLong(sessionId);
            writeString(msg, spaceId);
        });
     ...
     */
    @Override
    public AsyncFuture<OperationResult> deleteNameSpace(String spaceId) {
        return null;
    }
     ...
     */
    @Override
    public AsyncFuture<OperationResult> createDirectory(String spaceId, String path, String name) {
        return null;
    }
     ...
     */
    @Override
    public AsyncFuture<OperationResult> deleteDirectory(String spaceId, String path, String name) {
        return null;
    }
     ...
     */
    @Override
    public AsyncFuture<OperationResult> renameDirectory(String spaceId, String path, String oldName, String newName) {
        return null;
    }

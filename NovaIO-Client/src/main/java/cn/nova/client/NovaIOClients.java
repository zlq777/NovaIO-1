...
public final class NovaIOClients {
    ...
    public static NovaIOClient create(InetSocketAddress[] addresses){
        return create(List.of(addresses), DEFAULT_TIMEOUT, DEFAULT_IO_THREAD_NUMBER, DEFAULT_UPDATE_INTERVAL, DEFAULT_RECONNECT_INTERVAL);
    }
     ...
     * @return {@link NovaIOClient}
     */
    public static NovaIOClient create(Collection<InetSocketAddress> addresses,
